...
#let entry(title, date, subtitle, location) = [
  ...
  #grid(
    columns: (1fr, auto),
    [*#text(size: 11.5pt, weight: "bold")[#title]*], [#text(size: 10pt)[#date] #v(8pt)],
    [#text(style: "italic", size: 10pt)[#subtitle]],
    [#text(style: "italic", size: 10pt)[#location] #v(4pt)]
  )
  #v(-8pt)
]
...
- *Stack:* Vue.js, Nuxt, React, Bootstrap, Tailwind CSS, Symfony, Django, NestJS, Node.js, Stripe, Capacitor
